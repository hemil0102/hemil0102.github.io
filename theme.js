  ...
  function derive(base) {
    ...
    return {
      light: {
        ...
        '--header-glass':     css(h, hdrS, hdrL, 0.82),
        '--menu-glass':       css(h, hdrS, hdrL, 0.82), /* 펼침 메뉴: 뒤 콘텐츠가 비치는 반투명 유리 */
      ...
      dark: {
        ...
        '--header-glass':     css(h, dHdrS, dHdrL, 0.82),
        '--menu-glass':       css(h, dHdrS, dHdrL, 0.82),
